...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { code: @organisation.code, location: @organisation.location, name: @organisation.name } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { code: @organisation.code, location: @organisation.location, name: @organisation.name } }
